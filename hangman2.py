...
'animals': '''ant baboon badger bat bear bever camel cat clam cobra cougar
...
def getRandomWord(wordDict):
    # This function returns a random string from the passed dictionary of lists of strings and it's key.
    #First, randomly select a key from the dictinary:
